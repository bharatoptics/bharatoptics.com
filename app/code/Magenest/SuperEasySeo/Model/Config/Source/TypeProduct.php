 ...
 */
class TypeProduct implements SourceInterface, OptionSourceInterface
{
    const RENDER_URL_KEY = 1;
    const RENDER_DESCRIPTION = 2;
    const RENDER_SHORT_DESCRIPTION = 3;
    const RENDER_META_TITLE = 4;
    const RENDER_META_DESCRIPTION = 5;
    const RENDER_META_KEYWORD = 6;
    ...
    public static function getOptionArray()
    {
        return [
            ...
            self::RENDER_SHORT_DESCRIPTION => __('Short Description'),
