                ...
                if ($this->canShowPriceInfo($orderItem)) {
                    ...
                    if ($orderItem->getGstExclusive()) {
                        ...
                        $taxableAmount = round($orderItem->getRowTotal(), 2) -
                            round($orderItem->getCgstAmount(), 2) -
                            round($orderItem->getSgstAmount(), 2) -
                            round($orderItem->getIgstAmount(), 2) -
                            round($orderItem->getUtgstAmount(), 2) - $orderItem->getDiscountAmount();
                    }
